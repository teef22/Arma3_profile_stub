...
If you wish to use spaces or other characters in you profile name use [percent-encoding](https://developer.mozilla.org/en-US/docs/Glossary/Percent-encoding?_sm_nck=1) alongside regular alphanumeric characters.
